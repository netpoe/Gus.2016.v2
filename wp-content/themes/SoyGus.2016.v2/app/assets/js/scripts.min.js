...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    var a = document.documentElement, b = window, c = function(c, d) {
        ...
        init: function(a, d, e) {
            return this._wdw = a === b, this._target = a, this._tween = e, "object" != typeof d && (d = {
                y: d
            }), this.vars = d, this._autoKill = d.autoKill !== !1, this.x = this.xPrev = this.getX(), 
            this.y = this.yPrev = this.getY(), null != d.x ? (this._addTween(this, "x", this.x, "max" === d.x ? c(a, "x") : d.x, "scrollTo_x", !0), 
            this._overwriteProps.push("scrollTo_x")) : this.skipX = !0, null != d.y ? (this._addTween(this, "y", this.y, "max" === d.y ? c(a, "y") : d.y, "scrollTo_y", !0), 
            this._overwriteProps.push("scrollTo_y")) : this.skipY = !0, !0;
        },
        set: function(a) {
            ...
            this.x < 0 && (this.x = 0), this.y < 0 && (this.y = 0), this._autoKill && (!this.skipX && (g > 7 || -7 > g) && d < c(this._target, "x") && (this.skipX = !0), 
    ...
    a.Controller = function(d) {
        var f, g, h = "ScrollMagic.Controller", i = "FORWARD", j = "REVERSE", k = "PAUSED", l = c.defaults, m = this, n = e.extend({}, l, d), o = [], p = !1, q = 0, r = k, s = !0, t = 0, u = !0, v = function() {
            ...
            s && (n.container = window), t = y(), n.container.addEventListener("resize", C), 
            n.container.addEventListener("scroll", C), n.refreshInterval = parseInt(n.refreshInterval) || l.refreshInterval, 
            w();
        }, w = function() {
        ...
        return this.addScene = function(b) {
            if (e.type.Array(b)) b.forEach(function(a) {
                m.addScene(a);
            }); else if (b instanceof a.Scene) if (b.controller() !== m) b.addTo(m); else if (o.indexOf(b) < 0) {
            ...
            return e.type.Array(b) ? b.forEach(function(a) {
                m.updateScene(a, c);
            }) : c ? b.update(!0) : p !== !0 && b instanceof a.Scene && (p = p || [], -1 == p.indexOf(b) && p.push(b), 
            p = E(p), B()), m;
            ...
            if (e.type.Number(c)) z.call(n.container, c, d); else if (c instanceof a.Scene) c.controller() === m && m.scrollTo(c.scrollOffset(), d); else if (e.type.Function(c)) z = c; else {
            ...
            return n.container.removeEventListener("resize", C), n.container.removeEventListener("scroll", C), 
            e.cAF(f), null;
        }, v(), m;
    };
    var c = {
    ...
    a.Controller.addOption = function(a, b) {
        ...
        this.on = function(a, b) {
            ...
            return b instanceof a.Controller && g != b && (g && g.removeScene(l), g = b, z(), 
            v(!0), w(!0), u(), g.info("container").addEventListener("resize", x), b.addScene(l), 
            l.trigger("add", {
                controller: g
            }), l.update()), l;
        }, this.enabled = function(a) {
            ...
            } else C && n === i && E(!0); else g.updateScene(l, !1);
            return l;
            ...
            if (arguments.length) {
                ...
                if (0 === m.duration ? (b = o != a, o = 1 > a && e ? 0 : 1, n = 0 === o ? h : i) : 0 > a && n !== h && e ? (o = 0, 
                n = h, b = !0) : a >= 0 && 1 > a && e ? (o = a, n = i, b = !0) : a >= 1 && n !== j ? (o = 1, 
                n = j, b = !0) : n !== i || e || E(), b) {
                    var f = {
                        progress: o,
                        state: n,
                    ...
                    k && c !== i && (p("enter"), p(c === h ? "start" : "end")), p("progress"), k && n !== i && (p(n === h ? "start" : "end"), 
                    p("leave"));
                }
                return l;
            }
        ...
        var E = function(a) {
            ...
            if (C && g && D.inFlow) {
                ...
                D.relSize.width || D.relSize.autoFullWidth ? a ? e.css(C, {
                    ...
                    width: "100%"
                }) : (f["min-width"] = e.get.width(b ? C : c, !0, !0), f.width = a ? f["min-width"] : "auto"), 
                D.relSize.height ? a ? e.css(C, {
                    height: e.get.height(D.spacer) - (D.pushFollowers ? m.duration : 0)
                }) : e.css(C, {
                    height: "100%"
                }) : (f["min-height"] = e.get.height(b ? c : C, !0, !d), f.height = a ? f["min-height"] : "auto"), 
                D.pushFollowers && (f["padding" + (b ? "Top" : "Left")] = m.duration * o, f["padding" + (b ? "Bottom" : "Right")] = m.duration * (1 - o)), 
                e.css(D.spacer, f);
            }
        }, G = function() {
        ...
        this.setPin = function(a, c) {
            ...
            var k = C.parentNode.insertBefore(document.createElement("div"), C), m = e.extend(i, {
                position: h ? "relative" : "absolute",
                boxSizing: "content-box",
                mozBoxSizing: "content-box",
                webkitBoxSizing: "content-box"
            });
            if (h || e.extend(m, e.css(C, [ "width", "height" ])), e.css(k, m), k.setAttribute(b, ""), 
            e.addClass(k, c.spacerClass), D = {
                spacer: k,
                relSize: {
            ...
            }), window.addEventListener("scroll", G), window.addEventListener("resize", G), 
            window.addEventListener("resize", H), C.addEventListener("mousewheel", I), C.addEventListener("DOMMouseScroll", I), 
            E(), l;
            ...
            if (C) {
                if (n === i && E(!0), a || !g) {
                    ...
                    D.spacer.parentNode.insertBefore(c, D.spacer), D.spacer.parentNode.removeChild(D.spacer), 
                    C.parentNode.hasAttribute(b) || (e.css(C, C.___origStyle), delete C.___origStyle);
                }
                window.removeEventListener("scroll", G), window.removeEventListener("resize", G), 
                window.removeEventListener("resize", H), C.removeEventListener("mousewheel", I), 
                C.removeEventListener("DOMMouseScroll", I), C = void 0;
            }
            return l;
        };
        var J, K = [];
        return l.on("destroy.internal", function(a) {
            ...
            J = b, K = c, l.on("enter.internal_class leave.internal_class", function(a) {
    ...
    var d = {
        ...
        validate: {
            ...
            triggerHook: function(a) {
                ...
                if (e.type.Number(a)) a = Math.max(0, Math.min(parseFloat(a), 1)); else {
                    if (!(a in b)) throw 0;
                    a = b[a];
                }
                return a;
    ...
    a.Scene.addOption = function(a, b, c, e) {
        ...
        return this.type = a, this.target = this.currentTarget = c, this.namespace = b || "", 
    ...
    var e = a._util = function(a) {
        var b, c = {}, d = function(a) {
            ...
            if (c = c === document ? a : c, c === a) g = !1; else if (!l.DomElement(c)) return 0;
        ...
        return m.elements = function(b) {
            ...
            if ("nodelist" === l(b) || l.Array(b)) for (var e = 0, f = c.length = b.length; f > e; e++) {
                var g = b[e];
    ...
    $(document).ready(function() {
        $(".btn-call-to-action").click(function(a) {
            a.preventDefault(), $(this).text("yo@soygus.com");
        });
    });
}.call(this), function() {
    "use strict";
    $(document).ready(function() {
        var a = window.location.href.split("/"), b = $(".language-select");
        -1 == a.indexOf("es") ? b.find(".EN").addClass("active-language") : b.find(".ES").addClass("active-language");
    });
}.call(this), function() {
    "use strict";
    $(document).ready(function() {
        ...
        a = new ScrollMagic.Controller(), a.scrollTo(function(a) {
            ...
            var c, d;
            $("a[href^=#]").parent().removeClass("current-menu-item"), d = $(this).attr("href"), 
            c = "a[href^=" + d + "]", $(c).parent().addClass("current-menu-item"), $(d).length > 0 && !d.match(/nav/g) && !d.match(/carousel/g) && (b.preventDefault(), 
            a.scrollTo(d));
        });
    });
}.call(this);